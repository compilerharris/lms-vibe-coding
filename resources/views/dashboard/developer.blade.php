                    ...
                    <div class="col-12">
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <p class="text-muted">Welcome back, {{ Auth::user()->name }}! Here's what's happening with your projects and leads.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                @if($recent_leads->count() > 0)
                                    <div class="table-responsive">
                                        <table id="developerRecentLeadsTable" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $lead->channelPartner->name ?? 'Unassigned' }}</td>
                                                    <td>
...
$(document).ready(function() {
    $('#developerRecentLeadsTable').DataTable({
        responsive: true,
        pageLength: 25,
