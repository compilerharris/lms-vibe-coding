...
@section('title', 'Edit Lead - Lead Management System')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('subsource') is-invalid @enderror" 
                                           id="subsource" name="subsource" value="{{ old('subsource', $lead->subsource) }}" placeholder="e.g., Homepage Banner, Social Media Ad">
                                    @error('subsource')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
