                    ...
                    <div class="col-12">
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <p class="text-muted">Welcome back, {{ Auth::user()->name }}! Here are your assigned leads.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0"><i class="fas fa-users me-2"></i>My Assigned Leads</h5>
                            </div>
                            <div class="card-body">
                                ...
                                @else
                                    <div class="text-center py-4">
                                        ...
                                        <p class="text-muted">No leads assigned to you yet.</p>
                                    </div>
                                @endif
                            </div>
                        </div>
