...
@section('title', 'Add Real Estate Developer - Lead Assignment System')
...
@section('content')
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-plus me-2"></i>Add New Real Estate Developer</h2>
                        ...
                        <form method="POST" action="{{ route('developers.store') }}">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Create Real Estate Developer
                                </button>
                            </div>
                        </form>
                    </div>
