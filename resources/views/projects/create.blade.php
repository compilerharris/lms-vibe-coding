...
@section('content')
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3><i class="fas fa-plus me-2"></i>Create New Project</h3>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('projects.store') }}" method="POST" data-skip-loader>
                        @csrf
                        <div class="row">
                                ...
                                <select class="form-select @error('developer_user_id') is-invalid @enderror" 
                                    ...
                                    @foreach($developers as $developer)
                                        <option value="{{ $developer->id }}" 
                                                {{ old('developer_user_id') == $developer->id ? 'selected' : '' }}>
                                            {{ $developer->name }}
                                        </option>
                                    @endforeach
                                </select>
